      ...
      <div className="Form-container">
        <div className="formContainer min-w-screen lg:w-full min-h-screen">
          ...
          <form className="max-w-screen ">
            <div className="mb-6 ">
              <h2 className="text-4xl text-gray-700 font-extrabold mb-4 text-left lg:text-left">
                Log in
              </h2>
              <label
                htmlFor="email"
                className=" text-gray-500 bg-white block text-sm font-medium"
              >
                Email address:
              </label>
              <input
            ...
            <div className="mb-6">
              ...
              />
              <p className="text-left text-[#4A0808] text-sm mt-1">
                <br />
                <Link
                  to="/forgot-password"
                  className="text-[#4A0808]"
                  onClick={handleClick}
                >
                  {" "}
